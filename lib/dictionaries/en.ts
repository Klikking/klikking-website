...
const en: Dictionary = {
  ...
  aiAgents: {
    eyebrow: "AI AGENTS",
    badge: "NEW · KLIKKINGAI",
    h1: "More Google reviews, faster responses to complaints.",
    lede: "KlikkingAI is an AI agent built for local businesses: your guests review you by scanning a QR code — happy ones go straight to Google Maps, unhappy ones can message you privately and instantly, before they complain in public.",
    ctaPrimary: "See pricing",
    ctaLogin: "Login",
    howItWorksTitle: "How it works",
    steps: [
      {
        title: "You put up the QR code",
        text: "On the table, the counter, or the receipt — guests scan it with their phone.",
      },
      {
        title: "The guest rates their visit",
        text: "One star-rating question decides whether they go to Google or write a private message.",
      },
      {
        title: "Your AI agent responds instantly",
        text: "It helps draft a reply to every review, and you can handle complaints in minutes — before they escalate.",
      },
    ],
    featuresTitle: "Every tool in one place",
    featuresLede: "9 real features — no \"basic\" and \"premium\" tiers, you get everything at one price.",
    features: [
      { title: "QR & link routing", text: "A unique QR code and link for every business, with real-time scan statistics." },
      { title: "AI auto-reply", text: "A personalized reply to every Google review in minutes, sent directly." },
      { title: "Feedback inbox", text: "Every private guest message in one place — a complaint never gets lost in your inbox again." },
      { title: "SEO report", text: "A 0–100 score and concrete action items from your real Google Business Profile — your own data, not a guess." },
      { title: "Local grid & competitor analysis", text: "See exactly where in the city you rank, and where you're ahead of or behind a specific competitor." },
      { title: "Monthly trend stats", text: "This month vs. last: how many new reviews, what average, how fast you're replying." },
      { title: "Recovery & analysis", text: "AI helps decide which negative reviews may violate Google's policies, and preps you for reporting them." },
      { title: "Email campaigns", text: "Automatic, delayed review-request emails to your day's guests." },
      { title: "Email signature", text: "A professional signature with a built-in review-request button, in minutes." },
    ],
    pricingTitle: "One price. Every feature.",
    pricingLede: "No complicated tiers, no hidden premium level. No long-term commitment — cancel any time.",
    monthlyLabel: "Monthly",
    annualLabel: "Annual",
    savingsLabel: "save",
    perMonth: "mo",
    perYear: "yr",
    dailyPrice: "~{amount} Ft / day",
    dailyNote: "Less than a coffee a day, for 9 serious features.",
    included: [
      "QR code & private feedback page — unlimited scans",
      "AI auto-reply — a response assistant for every review",
      "Feedback inbox",
      "SEO report — profile health score",
      "Local Grid + competitor comparison",
      "Monthly trend stats and response-time tracking",
      "Recovery & AI policy analysis",
      "Email campaigns with automatic sending",
      "Email signature generator",
    ],
    ctaButton: "Start subscription",
    legalNote: {
      pre: "By subscribing you agree to the ",
    ...
    faq: [
      {
        q: "Is this the same company as Klikking?",
        a: "Yes — KlikkingAI is Klikking's own software product, built by the same developer who builds the websites.",
      },
      {
        q: "Do I need technical skills?",
        a: "No — setup takes a few minutes, and you can print the QR code on any printer.",
      },
      {
        q: "Can I cancel any time?",
        a: "Yes, there's no long-term commitment — cancel your subscription with one click in your Stripe account.",
      },
    ],
  },
  work: {
