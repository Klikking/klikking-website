...
const hu: Dictionary = {
  ...
  aiAgents: {
    eyebrow: "AI ÜGYNÖKÖK",
    badge: "ÚJ · KLIKKINGAI",
    h1: "Több Google-értékelés, gyorsabb reagálás a panaszokra.",
    lede: "A KlikkingAI egy AI ügynök, ami helyi vállalkozásoknak dolgozik: a vendégeid egy QR-kód beolvasásával értékelnek — az elégedettek a Google Térképre jutnak, az elégedetlenek pedig azonnal, privátan írhatnak neked, mielőtt nyilvánosan panaszkodnának.",
    ctaPrimary: "Árak megtekintése",
    ctaLogin: "Bejelentkezés",
    howItWorksTitle: "Így működik",
    steps: [
      {
        title: "Kihelyezed a QR-kódot",
        text: "Az asztalra, a pultra vagy a nyugtára — a vendég a telefonjával olvassa be.",
      },
      {
        title: "A vendég értékel",
        text: "Egy csillagos kérdés dönti el, hogy a Google-re megy, vagy privát üzenetet ír.",
      },
      {
        title: "Az AI ügynök azonnal reagál",
        text: "Segít a válaszban minden értékelésre, a panaszokat pedig percek alatt kezelheted, mielőtt eszkalálódnának.",
      },
    ],
    featuresTitle: "Minden eszköz egy helyen",
    featuresLede: "9 komoly funkció — nincs „alap” és „prémium” csomag, mindent megkapsz egy áron.",
    features: [
      { title: "QR & Link Routing", text: "Egyedi QR-kód és link minden vállalkozásnak, valós idejű beolvasás-statisztikával." },
      { title: "AI Auto-Reply", text: "Percek alatt személyre szabott válasz minden Google-értékelésre, közvetlenül kiküldve." },
      { title: "Beérkezett visszajelzések", text: "Minden privát vendégüzenet egy helyen — soha többé nem vész el egy panasz a beérkező leveleid között." },
      { title: "SEO jelentés", text: "Egy 0–100-as pontszám és konkrét teendők a valódi Google Cégprofilodból — nem becslés, a saját adataid." },
      { title: "Local Grid & versenytárs-elemzés", text: "Lásd, a város mely pontjairól hányadik helyen jelensz meg — és pontosan hol előzöl vagy maradsz le egy konkurenstől." },
      { title: "Havi trend statisztikák", text: "Ez a hónap az előzőhöz képest: hány új értékelés, mekkora az átlag, milyen gyorsan válaszolsz." },
      { title: "Helyreállítás & elemzés", text: "AI segít eldönteni, mely negatív értékelés sértheti a Google irányelveit, és felkészít a jelentésre." },
      { title: "E-mail kampányok", text: "Automatikus, késleltetett értékeléskérő e-mailek a napi vendégeidnek." },
      { title: "E-mail aláírás", text: "Beépített értékeléskérő gombbal ellátott professzionális aláírás percek alatt." },
    ],
    pricingTitle: "Egy ár. Minden funkció.",
    pricingLede: "Nincs bonyolult csomagválasztás, nincs elrejtett prémium szint. Nincs hosszútávú elköteleződés, bármikor lemondható.",
    monthlyLabel: "Havi",
    annualLabel: "Éves",
    savingsLabel: "spórolj",
    perMonth: "hó",
    perYear: "év",
    dailyPrice: "napi ~{amount} Ft",
    dailyNote: "Kevesebb, mint egy kávé ára naponta — 9 komoly funkcióért.",
    included: [
      "QR-kód & privát visszajelző oldal — korlátlan beolvasás",
      "AI Auto-Reply — válaszadó asszisztens minden értékelésre",
      "Beérkezett visszajelzések inbox",
      "SEO jelentés — profil egészség pontszám",
      "Local Grid + versenytárs-összehasonlítás",
      "Havi trend statisztikák és válaszidő-mérés",
      "Helyreállítás & AI jogi elemzés",
      "E-mail kampányok automatikus küldéssel",
      "E-mail aláírás generátor",
    ],
    ctaButton: "Előfizetés indítása",
    legalNote: {
      pre: "Az előfizetéssel elfogadod az ",
    ...
    faq: [
      {
        q: "Ez ugyanaz a cég, mint a Klikking?",
        a: "Igen — a KlikkingAI a Klikking saját szoftverterméke, ugyanattól a fejlesztőtől, aki a weboldalakat is építi.",
      },
      {
        q: "Kell hozzá technikai tudás?",
        a: "Nem — a beállítás néhány percet vesz igénybe, és a QR-kódot bármelyik nyomtatóval kinyomtathatod.",
      },
      {
        q: "Bármikor lemondhatom?",
        a: "Igen, nincs hosszútávú elköteleződés, a Stripe-fiókodban egy kattintással lemondhatod az előfizetést.",
      },
    ],
  },
  work: {
